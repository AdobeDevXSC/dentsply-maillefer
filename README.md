...
## Environments
- Preview: https://main--dentsply-maillefer--adobedevxsc.aem.page/
- Live: https://main--dentsply-maillefer--adobedevxsc.aem.live/
...
1. Open the `dentsply-maillefer` directory in your favorite IDE and start coding :)
